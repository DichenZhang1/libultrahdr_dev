...
void transformYuv420(uhdr_uncompressed_ptr image, size_t x_chroma, size_t y_chroma,
                     ColorTransformFn fn) {
...
Color getYuv420Pixel(uhdr_uncompressed_ptr image, size_t x, size_t y) {
...
Color getP010Pixel(uhdr_uncompressed_ptr image, size_t x, size_t y) {
...
typedef Color (*getPixelFn)(uhdr_uncompressed_ptr, size_t, size_t);

static Color samplePixels(uhdr_uncompressed_ptr image, size_t map_scale_factor, size_t x, size_t y,
...
Color sampleYuv420(uhdr_uncompressed_ptr image, size_t map_scale_factor, size_t x, size_t y) {
  return samplePixels(image, map_scale_factor, x, y, getYuv420Pixel);
}

Color sampleP010(uhdr_uncompressed_ptr image, size_t map_scale_factor, size_t x, size_t y) {
...
float sampleMap(uhdr_uncompressed_ptr map, float map_scale_factor, size_t x, size_t y) {
...
float sampleMap(uhdr_uncompressed_ptr map, size_t map_scale_factor, size_t x, size_t y,
